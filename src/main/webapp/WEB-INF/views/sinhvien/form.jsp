...
<div class="container my-5">
    ...
    <div class="card shadow-sm" data-aos="fade-up" data-aos-delay="100">
        <div class="card-body">
            <form:form action="${pageContext.request.contextPath}/manage/sinhvien/save" modelAttribute="sinhVien" method="post" id="sinhVienForm">
                ...
                <a href="<c:url value='/manage/sinhvien'/>" class="btn btn-secondary"><i class="fas fa-arrow-left"></i> Quay lại</a>
            </form:form>
        </div>
    </div>
</div>
