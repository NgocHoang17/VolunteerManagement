...
<div class="container my-5">
    ...
    <div class="card shadow-sm" data-aos="fade-up" data-aos-delay="100">
        <div class="card-body">
            <form:form action="${pageContext.request.contextPath}/manage/thamgia/save" modelAttribute="thamGia" method="post" id="thamGiaForm">
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <form:select path="xepLoai" class="form-select">
                        <form:option value="">-- Chọn xếp loại --</form:option>
                        <form:option value="Xuất sắc">Xuất sắc</form:option>
                        <form:option value="Tốt">Tốt</form:option>
                ...
                <a href="<c:url value='/manage/thamgia'/>" class="btn btn-secondary"><i class="fas fa-arrow-left"></i> Quay lại</a>
            </form:form>
        </div>
    </div>
</div>
