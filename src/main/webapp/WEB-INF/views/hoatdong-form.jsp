...
<div class="container my-5">
    ...
    <div class="card shadow-sm" data-aos="fade-up" data-aos-delay="100">
        <div class="card-body">
            <form:form action="/hoatdong/save" modelAttribute="hoatDong" method="post" id="hoatDongForm">
                ...
                <a href="/hoatdong" class="btn btn-secondary"><i class="fas fa-arrow-left"></i> Quay lại</a>
            </form:form>
        </div>
    </div>
</div>
